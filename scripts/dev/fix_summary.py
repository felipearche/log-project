...
mask_stale = (df["date"] == "2025-08-23") & (df["dataset"] == "synth_tokens") & (df["TPR_at_1pct_FPR"].isna())
...
df.loc[mini, "TPR_at_1pct_FPR"] = df.loc[mini, "TPR_at_1pct_FPR"].where(df.loc[mini, "TPR_at_1pct_FPR"].notna(), "NA")
